...
def getCacheBroswer(currentPath):
	...
	cmd = 'c: & copy "%USERPROFILE%\\AppData\\Local\\Google\\Chrome\\User Data\\Default\\Cache" '+currentPath+'\\REPORT\\CacheBroswer\\Chrome'
	execCMD(cmd)

	cmd = 'c: & copy "%USERPROFILE%\\AppData\\Local\\CocCoc\\Browser\\User Data\\Default\\Cache" '+currentPath+'\\REPORT\\CacheBroswer\\CocCoc'
	execCMD(cmd)

	cmd = 'c: & copy "%USERPROFILE%\\AppData\\Local\\Mozilla\\Firefox\\Profiles" '+currentPath+'\\REPORT\\CacheBroswer\\FireFox'
	execCMD(cmd)

	cmd = 'c: & copy "%localappdata%\\Microsoft\\Windows\\INetCache\\IE" '+currentPath+'\\REPORT\\CacheBroswer\\IE'
	execCMD(cmd)
