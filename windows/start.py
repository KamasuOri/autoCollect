...
getDiskImageCheck = IntVar()
getRamImageCheck = IntVar()
...
Checkbutton(master, text="Ram Image", variable=getRamImageCheck).grid(row=7, sticky=W)
Checkbutton(master, text="Disk Image", variable=getDiskImageCheck).grid(row=8, sticky=W)
Button(master, text='Run check', command=startCollect).grid(row=9, sticky=W, pady=10)
mainloop()

# print getRamDiskImage.getDiskImage()
